    ...
    const handleDayChange = (e, index) => {
        ...
        setFormData(prevData => {
            ...
            if (e.target.checked) {
                ...
                updatedSchedules[index].day = updatedSchedules[index].day.filter(d => d !== day);
            }
            return {
                ...prevData,
                schedules: updatedSchedules
    ...
    const handleSubmit = async (e) => {
        ...
        for (let schedule of formData.schedules) {
            if (schedule.hourStart >= schedule.hourEnd) {
                alert("L'heure de début doit être inférieure à l'heure de fin pour tous les horaires.");
                return;
            }
        ...
        if (formData.rainThreshold < 0 || formData.moistureThreshold < 0 || formData.duration < 0) {
        ...
        <div
            ...
            <form
                ...
                <div className={styles.thresholdContainer}>
                    <h2 className={styles.title}>Configuration des seuils et durée d'arrosage</h2>
                ...
                <div className={styles.scheduleContainer}>
                    ...
                    {formData.schedules.map((schedule, index) => (
                            ...
                            <div className={styles.scheduleActivation}>
                                ...
                                <input
                                    ...
                                    onChange={(e) => {
                                        ...
                                        setFormData(prevData => ({ ...prevData, schedules: updatedSchedules }));
                                    }}
                                />
                            </div>
                        ...
                        <label htmlFor={`day${day}${index}`}>{day}</label>
                            ...
                            <CustomButton text="Supprimer le créneau" onClick={() => removeSchedule(index)} />
                        </div>
                    ))}
                    <CustomButton text="Ajouter un nouvel créneau" onClick={addNewSchedule} />
                </div>
